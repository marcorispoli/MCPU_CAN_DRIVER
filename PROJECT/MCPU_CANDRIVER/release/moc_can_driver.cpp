...
QT_MOC_LITERAL(36, 19), // "transmittedCanFrame"
QT_MOC_LITERAL(56, 13) // "canTimerEvent"

    },
    "canDriver\0receivedCanFrame\0\0id\0data\0"
    "transmittedCanFrame\0canTimerEvent"
};
...
void canDriver::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->transmittedCanFrame((*reinterpret_cast< ushort(*)>(_a[1])),(*reinterpret_cast< QByteArray(*)>(_a[2]))); break;
        case 2: _t->canTimerEvent(); break;
        default: ;
        }
        ...
        {
            using _t = void (canDriver::*)(ushort , QByteArray );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&canDriver::transmittedCanFrame)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void canDriver::transmittedCanFrame(ushort _t1, QByteArray _t2)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))), const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t2))) };
